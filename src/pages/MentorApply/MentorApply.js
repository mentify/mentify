...
const MentorApplyStyled = styled.div`
    ...
    export class MentorApply extends React.Component {
        render(){
            return (
                <MentorApplyStyled className="MentorApplyStyled">
                    <div className="toppart">
                       <div className="line1"> Mentor <span className="yellow">Students</span> and earn upto ₹20,000 per month</div>
                       <div className="line2">Every student has some experience to share</div>
                       <div className="btn"><Link to="/mentorform" ><button>Apply Now</button></Link></div>
                    </div>
                    <div className="image">
                    ...
                    <div className="bottompart">
                        ...
                        <div className="btn2"><Link to="/mentorform" ><button>Apply as a mentor</button></Link></div>
                    </div>
                    <Footer/>
                </MentorApplyStyled>
