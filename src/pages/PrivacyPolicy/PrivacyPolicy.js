...
mentify.in recognises the importance of maintaining your privacy. We value your privacy and appreciate your trust in us. This Privacy Policy sets out how mentify.in uses and protects any information that you give mentify.in when you use this www.mentify.in or the mentify.in mobile application or  any other digital medium and other offline sources of our Company. mentify.in is committed to ensure that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this Privacy Policy as it describes how we treat user information we collect from you, the policies and procedures on the collection, use, disclosure and protection of your information when you use our mentify.in Platform.
This Privacy Policy applies to current and former visitors to  our mentify.in Platform and to our online customers. By visiting and/or using our website, you agree to this Privacy Policy. mentify.in may change this policy from time to time by updating this page. You should check this page from time to time  to ensure that you are happy with any changes.
www.mentify.in is a property of mentify.in , Other , established under laws of India, having its registered office at Other , Telangana - 500078 .
<br/>
<br/>

<h2>DEFINITIONS:</h2>
The terms " mentify.in ", "Company", "we", "us" and "our" refer to the mentify.in .
<br/>
<br/>

The term " mentify.in Platform" refers to www.mentify.in or the mentify.in mobile application or any other digital medium  and other offline sources.
...
mentify.in whether on the Swiggy Platform or otherwise.
The term "Policy" refers to this Privacy Policy.
Please read this Policy before using the mentify.in Platform or submitting any personal information to mentify.in . This Policy is a part of and incorporated within, and is to be read along with, the Terms   of  Use https://www.termsandconditionsgenerator.com/live.php? token=oSmOTjTMBG0GJhnrFu9RrdJ16vWfShX4 .
<br/>
<br/>
...
We collect information you post in a public space on our mentify.in Platform or on a third-party social media site belonging to mentify.in .
<br/>
<br/>

<h2>Usage and Preference Information:</h2>
We collect information as to how you interact with our Services, preferences expressed and settings chosen. mentify.in Platform includes the mentify.in advertising services ("Ad Services"), which may collect user activity and browsing history within the mentify.in Platform and across third-party sites and online services, including those sites and services that include our ad pixels ("Pixels"), widgets, plug-ins, buttons, or related services or through the use of cookies. Our Ad Services collect browsing information including, without limitation, your Internet  protocol (IP) address and location, your login information, browser type and version, date and time stamp, user agent, mentify.in cookie ID (if applicable), time zone setting, browser plug-in types and versions, operating system and platform, and other information about user activities on the mentify.in Platform, as well as on third party sites and services that have embedded our Pixels, widgets, plug-ins, buttons, or related services.
...
mentify.in mobile application ( mentify.in app) may also access metadata and other information associated with other files stored on your mobile device. This may include, for example, photographs, audio and video clips, personal contacts and address book information. If you permit the mentify.in app to access the address book on your device, we may collect names and contact information from your address book to facilitate  social interactions through our services and for other purposes described in this Policy or at the time of consent or collection. If you permit the mentify.in app to access the calendar on your device, we collect calendar information such as event title and description, your response (Yes, No, Maybe), date and time, location and number of attendees. If you are a partner company, we will, additionally, record your calls with us made from the device used to provide Services, related call details, SMS details location and address details.
Demographic information:
We may collect demographic information about you, events you like, events you intend to participate in, tickets you buy, or any other information provided by you during the use of mentify.in Platform. We might collect this as a part of a survey also.
Other information:
If you use mentify.in Platform, we may collect information about your IP address and the browser you're using. We might look at what site you came from, duration of time spent on our website, pages accessed or what site you visit when you leave us. We might also collect the type of mobile device you are using, or the version of the operating system your computer or device is running.
<br/>
<br/>
...
<br/>
<br/>
We collect information directly from you when you register on mentify.in Platform. We also collect information if you post a comment on mentify.in Platform or ask us a question through phone or email or any other source of communication.
We collect information from you passively:
We use tracking tools like for collecting information about your usage of our website.
...
We might use the information you provide to contact you for confirmation of a purchase on mentify.in Platform or for other promotional purposes.
...
While you place a request to order through the mentify.in Platform, your information is provided to us and to the vendors with whom you may choose to order. In order to facilitate your online order processing, we provide your information to that vendors in a similar manner as if you had made a goods/products/food order directly with the vendors. If you provide a mobile phone number, mentify.in may send you text messages regarding the orders delivery status.
...
<h2>COOKIES:</h2>
Our mentify.in Platform and third parties with whom we partner, may use cookies, pixel tags, web beacons, mobile  device IDs, "flash cookies" and similar files or technologies to collect and store information with respect to your use of the Services and third-party websites.
...
Analysing site traffic and trends, and generally understanding the online behaviours and interests of people who interact with our
<br/>
<br/>
<h2>services.</h2>
...
We may also allow third parties to provide audience measurement and analytics services for us, to serve advertisements on our behalf across the Internet, and to track and report on the performance of those advertisements. These entities may use cookies, web beacons, SDKs and other technologies to identify your device when you visit  the  mentify.in Platform and use our Services, as well as when you visit other online sites and services.
Please see our Cookie Policy here for more information regarding the use of cookies and other technologies described in this section, including regarding your choices relating to such technologies.
<br/>
<br/>
...
We have in place appropriate technical and security  measures to secure the information collected by us. We use vault and tokenization services from third party service providers to protect the sensitive personal information provided by you.  Where we have given you (or where you have chosen) a username and password which enables you to access certain parts of the mentify.in Platform, you are responsible for keeping these details confidential. We ask you not to share your  password with anyone.
Please be aware that the transmission of information via the internet is not completely secure. Although we will do our best to protect your personal data, we cannot guarantee the security of your data transmitted through the mentify.in Platform. Once we have received your information, we will use strict physical, electronic, and procedural safeguards to try to prevent unauthorised access.
<br/>
<br/>

<h2>Email OPT-OUT:</h2>
You can opt out of receiving our marketing emails. To stop receiving    our promotional emails, please  email
( mentifytvd@gmail.com ).   It  may take    about       days    to
process your request. Even if you opt out of getting marketing messages, we will still be sending you transactional messages through email and SMS about your purchases.
...
The mentify.in Platform may contain links to other websites.  If you click on one of the links to third party websites, you may be taken to websites we do not control. Any personal information about you collected whilst visiting such websites is not governed by this Policy. mentify.in shall not be responsible for and has no control over the practices and content of any website accessed using the links contained on the mentify.in Platform. Read the privacy policy of other websites carefully as this policy does not apply to the privacy practices of those websites. We are not responsible for these third party sites.
...
In accordance with Information Technology Act 2000 and rules made and applicable there under, the name and contact details of the Grievance Officer are provided below:
Name:
Address:
Phone Number:
Email Address:
...
Further, please note that the mentify.in Platform stores your data with the cloud platform of provided by (Name of the Service Provider), which may store this data on their servers located .  has security measures in place to protect the loss, misuse and alteration of the information, details of which are available at . The privacy policy adopted by are detailed in .
In the event you have questions or concerns about the security measures adopted by , you can contact their data protection/ privacy team/ legal team or designated grievance officer at these organisations, whose contact details are available in its privacy policy, or can also write to our Grievance Officer at the address provided above.
If you have any queries relating to the processing or usage of information provided by you in connection with this Policy  or other privacy concerns, you can email us at mentifytvd@gmail.com .
</p>
</PrivacyPolicyStyled>
        )
}