				...
				<div className="detailscontactus">
					...
					<div className="foundercardmain">
						<div className="foundercard">
							...
							<br/>
							<div className="foundertext"> Mr. Omnipresent 🤵 </div>
						</div>
						...
						<div className="foundercard">
							...
							<br/>
							<div className="foundertext"> Night Owl  🦉 </div>
						</div>
						<div className="foundercard">
							...
							<br/>
							<div className="foundertext">Bookworm 🤓</div>
						</div>
						<div className="foundercard">
							...
							<br/>
							<div className="foundertext"> Cricket Lunatic 🏏 </div>
						</div>
					</div>
					<div className="teamMembers2">
						<div className="person"><img src={Antony} className="Antony"/><div className="personName">Antony Joseph</div><div>Economist 📉</div></div>
