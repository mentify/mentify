      ...
      <div className="page2">
        ...
        <div className="details">
          ...
          <div className="details-description">
            Choosing a college right after 12th grade isn't an easy task. We
            help you connect with students in those colleges you are looking out
            for.
          </div>
          <div className="details-description">
          ...
          <div className="details-description">
            Getting an internship while in college isn't an easy task. We help
      ...
      <div className="colleges">
        ...
        <div className="collegeList">
          ...
          <img
            src={college4}
            alt="collegeimg"
            className="iitmadras collegeImage"
          />
          <img
            src={college6}
            alt="collegeimg"
            className="iitpatna collegeImage"
          />
        </div>
      </div>
      <Footer />
